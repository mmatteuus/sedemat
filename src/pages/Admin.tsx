...
import { ArrowLeft, Users, Folders, ShieldCheck, Copy } from 'lucide-react';
        ...
        <div className="mb-6">
          <Card>
            ...
            <CardContent className="flex flex-col gap-3 md:flex-row md:items-center">
              <Input value={basePath} readOnly className="flex-1" />
              <Button variant="outline" onClick={copyPath} disabled={!basePath}>
